        ...
        >
           {selectedArticle && (
             <div className="max-w-3xl mx-auto px-6 md:px-12 py-16 md:py-24">
                <div className="flex flex-wrap items-center gap-6 text-xs font-bold uppercase tracking-widest text-slate-400 mb-12 pb-8 border-b border-slate-100">
                   <span className="px-3 py-1 bg-slate-100 text-slate-900 rounded-full">{selectedArticle.category}</span>
                ...
                <div className="prose prose-slate prose-lg md:prose-xl max-w-none prose-headings:font-serif prose-headings:font-medium prose-p:font-light prose-p:text-slate-600 prose-a:text-slate-900 prose-a:no-underline hover:prose-a:underline">
                   <p className="lead text-2xl md:text-3xl font-serif text-slate-900 italic mb-10 leading-relaxed">
                   ...
                   <figure className="my-12">
                      <div className="aspect-video bg-slate-100 rounded-none flex items-center justify-center text-slate-300 border border-slate-200">
                         <BookOpen size={48} strokeWidth={1} />
                      </div>
                      <figcaption className="text-center text-xs font-mono text-slate-400 mt-4">Fig 1. Ilustração conceitual.</figcaption>
                   </figure>
                ...
                <div className="mt-20 pt-10 border-t border-slate-100 flex justify-between items-center">
                   <div>
                       <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-1">Escrito por</p>
                       <p className="font-serif text-lg text-slate-900">Victor Cardoso</p>
                   </div>
                   <button className="text-xs font-bold uppercase tracking-widest text-slate-900 hover:text-slate-500 transition-colors">
                      Compartilhar
                   </button>
                </div>
             </div>
