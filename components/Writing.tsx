...
const Writing: React.FC = () => {
  return (
    <section id="writing" className="py-32 bg-white relative z-10 border-t border-slate-100">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <Reveal>
                <div>
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3 block">Knowledge Share</span>
                    <h2 className="text-4xl md:text-5xl font-serif font-medium text-slate-900">Artigos & Insights</h2>
                </div>
            </Reveal>
            <Reveal delay={100}>
                 ...
                 <div className="h-full p-8 rounded-[2rem] bg-slate-50 border border-slate-100 hover:border-slate-300 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col justify-between">
                    <div>
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 group-hover:text-slate-900 group-hover:border-slate-900 transition-colors">
                    ...
                    <div className="flex items-center gap-4 pt-6 border-t border-slate-200 mt-6 text-[10px] font-bold uppercase tracking-widest text-slate-400">
