      ...
      <div className="container mx-auto px-6 md:px-12 xl:px-20">
        ...
        <div className="text-center mb-20 max-w-2xl mx-auto">
          ...
          <Reveal width="100%" variant="translate">
            <h2 className="text-4xl md:text-5xl font-display font-medium mb-6 text-slate-900 tracking-tight">
          ...
          {SKILLS.map((skill, index) => {
            ...
            return (
              <Reveal key={index} delay={index * 150} width="100%" variant="scale">
                <div
                  className="h-full glass-card p-8 md:p-10 rounded-[2.5rem] border border-slate-200/60 hover:border-slate-300 transition-all duration-500 flex flex-col bg-white/40 shadow-sm hover:shadow-2xl hover:-translate-y-2"
                >
                  {/* Header */}
                  <div className="mb-6 transform transition-transform duration-500 hover:translate-z-10" style={{ transformStyle: 'preserve-3d' }}>
                    ...
                    <h3 className="text-2xl font-sans font-medium mb-3 text-slate-900">
                      {skill.title}
                    </h3>
