          ...
          {SERVICES.map((service, index) => {
            ...
            return (
              <Reveal key={index} delay={index * 150} width="100%" variant="scale">
                {/* Performance Optimization: Removed Tilt, using CSS hover only */}
                <div className="h-full bg-slate-950/80 backdrop-blur-md p-8 rounded-[2rem] hover:bg-slate-900/90 hover:-translate-y-2 transition-all duration-300 border border-white/10 hover:border-white/20 group shadow-xl">
                  ...
                  <h3 className="text-xl font-sans font-medium mb-4 text-slate-100">{service.title}</h3>
