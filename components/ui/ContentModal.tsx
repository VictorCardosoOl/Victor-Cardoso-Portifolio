        ...
        <>
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-full z-50 px-6 py-6 md:px-12 md:py-8 flex items-start justify-end pointer-events-none">
              <div className="pointer-events-auto">
                <Magnetic strength={0.3}>
                  <button
                    onClick={onClose}
                    className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-petrol-base hover:bg-white hover:text-[#0B232E] flex items-center justify-center transition-all duration-300 shadow-lg group"
                  >
            ...
            <div
              ...
              className="flex-grow h-full w-full overflow-y-auto relative bg-[#F2F4F6] no-scrollbar"
              data-lenis-prevent
            >
