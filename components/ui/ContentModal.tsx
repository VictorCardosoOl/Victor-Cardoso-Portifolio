...
const ContentModal: React.FC<ContentModalProps> = ({ 
  ...
  // Bloqueio de Scroll e Ajuste de Padding
  useEffect(() => {
    if (isOpen) {
      lenis?.stop();
      document.body.style.overflow = 'hidden';
      // Compensar layout shift da barra de rolagem
  ...
  // Gestos de arrastar para fechar (Mobile)
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            onClick={onClose}
            className="fixed inset-0 z-[9990] bg-slate-950/60 backdrop-blur-md cursor-pointer"
            aria-hidden="true"
          />

          {/* Container do Modal (Sheet) */}
          <motion.div
            initial={{ y: "100%" }}
