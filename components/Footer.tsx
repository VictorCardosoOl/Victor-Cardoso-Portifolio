...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="site-footer" className="relative bg-[#0B232E] text-paper h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 xl:px-20 relative z-10 flex-1 flex flex-col py-12 md:py-24">
         ...
         {/* Live Status Widget (Fox Fuel Style) */}
         <div className="flex justify-between items-start border-b border-white/10 pb-8">
             <div className="flex flex-col">
                 <span className="text-micro text-white/40 mb-1">Live Status</span>
             ...
             <div className="text-right hidden md:block">
                 ...
                 <span className="text-sm font-light text-white block">Aceitando projetos Q3/Q4</span>
             </div>
         </div>
         ...
         <div className="flex-1 flex flex-col justify-center items-center text-center">
            <Magnetic strength={0.2}>
                ...
                >
                    <span className="text-micro text-[#2DD4BF] mb-4 block opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform translate-y-4 group-hover:translate-y-0">
                        [ INICIAR PROTOCOLO ]
                    </span>
                    <h2 className="text-[14vw] md:text-[12vw] leading-[0.85] font-serif font-medium tracking-tighter text-paper mix-blend-difference z-20 relative transition-all duration-700 group-hover:tracking-normal">
                        Vamos <br/>
         ...
         {/* Bottom Bar & Colophon */}
         <div className="w-full border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-end gap-8">
             
             {/* Left: Colophon */}
             <div className="flex flex-col gap-2 max-w-md">
                 <span className="text-micro text-white/40">Colophon</span>
             ...
             <div className="flex gap-8">
                 {CONTACT_INFO.socials.map((social, idx) => (
                    <a 
                        ...
                        className="text-micro text-white hover:text-[#2DD4BF] transition-colors flex items-center gap-1 group"
                    >
