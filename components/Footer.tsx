...
const Footer: React.FC = () => {
    ...
    return (
        <footer id="site-footer" className="relative bg-[#0B232E] text-paper min-h-screen w-full flex flex-col justify-between overflow-hidden group/footer">

            {/* Background Image - Local Asset */}
            <div className="absolute inset-0 z-0">
                <img
                    src="/images/footer_office.jpg"
                    alt="Office Atmosphere"
                    className="w-full h-full object-cover transition-transform duration-[2s] ease-out group-hover/footer:scale-105"
                />
                {/* Tint Overlay: "Apenas a imagem com a cor diferente" */}
                {/* Normal: Heavy Petrol Tint. Hover: Lightens slightly to reveal more detail */}
                <div className="absolute inset-0 bg-[#0B232E]/90 transition-opacity duration-700 group-hover/footer:opacity-80 mix-blend-multiply"></div>
                <div className="absolute inset-0 bg-[#0B232E]/80 transition-opacity duration-700"></div>
            </div>
                ...
                <div className="flex-1 flex flex-col justify-center items-center text-center">
                    <Magnetic strength={0.2}>
                        ...
                        >
                            ...
                            <h2 className="text-[clamp(3rem,9vw,7rem)] leading-[0.9] font-serif font-medium tracking-tighter text-paper z-20 relative transition-all duration-700 group-hover:tracking-normal pb-2">
                                Vamos <br />
                                <span className="italic text-white/30 group-hover:text-white transition-colors duration-700">Trabalhar?</span>
                            </h2>
                        </a>
                    </Magnetic>
                </div>
