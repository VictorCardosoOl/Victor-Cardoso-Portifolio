        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                ...
                <div className="flex gap-6">
                  {CONTACT_INFO.socials.map((social, idx) => (
                    <a 
                      key={idx} 
                      href={social.url} 
                      className="flex items-center gap-1 text-base font-medium hover:text-gray-500 transition-colors group"
                    >
                      {social.name}
          ...
          <div className="bg-gray-50 p-8 md:p-12">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-xs uppercase tracking-wider text-gray-500 mb-2">Nome</label>
                <input 
                  type="text" 
                  id="name"
              ...
              <div>
                <label htmlFor="message" className="block text-xs uppercase tracking-wider text-gray-500 mb-2">Mensagem</label>
                <textarea 
                  id="message"
                  rows={4}
              ...
              <button 
                type="submit"
                className="w-full bg-black text-white py-4 text-sm uppercase tracking-widest hover:bg-gray-800 transition-colors mt-4"
              >
                Enviar Mensagem
              </button>
            </form>
