...
const Hero: React.FC = () => {
  ...
  React.useEffect(() => {
    // "Explorer" unlocked just by starting the journey (after a small delay)
          ...
          <div className="w-full lg:w-7/12 order-2 lg:order-2 text-center lg:text-left">
            ...
            <div className="space-y-8 max-w-3xl mx-auto lg:mx-0">
              ...
              <div className="space-y-6">
                <Reveal width="100%">
                  <span className="inline-block px-4 py-1.5 glass-panel rounded-full text-[10px] md:text-xs font-bold tracking-widest uppercase text-slate-500 border border-slate-200/50 shadow-sm">
                    Disponível para novos projetos
                  </span>
                </Reveal>

                <div className="overflow-visible pb-2"> {/* overflow-visible to help with descenders */}
                  <h1 className="text-5xl md:text-7xl lg:text-9xl xl:text-[10rem] font-serif font-medium lg:font-semibold leading-[1.05] md:leading-[1] tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-slate-900 via-slate-800 to-slate-600 mix-blend-multiply pb-4">
                    <TextReveal delay={100}>Transformo ideias em</TextReveal>
                    <TextReveal delay={200} className="italic text-slate-400 font-serif font-light">negócios digitais.</TextReveal>
                  </h1>
                </div>
              </div>
